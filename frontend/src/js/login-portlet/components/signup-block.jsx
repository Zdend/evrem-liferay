...
var SignupBlock = React.createClass({
	...
	render: function(){
		return (
			<div>
				<h2>Sign up</h2>
				<input type="text" value={this.state.email} placeholder="Email" onChange={this.onEmailChange} onBlur={this.updateEmail} bsStyle="error" />
				<br />
				<input type="password" value={this.state.password1} placeholder="Password" onChange={this.onPassword1Change} onBlur={this.updatePassword1} />
				<br />
				<input type="password" value={this.state.password2} placeholder="Password again" onChange={this.onPassword2Change} onBlur={this.updatePassword2} />
				<br />
