...
import net.evrem.service.service.GridItemLocalService;
...
/**
 * Provides the base implementation for the grid item local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.evrem.service.service.impl.GridItemLocalServiceImpl}.
 * </p>
 *
 * @author Zdenek Vecek
 ...
 * @generated
 */
public abstract class GridItemLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements GridItemLocalService, IdentifiableBean {
    ...
    private GridItemLocalServiceClpInvoker _clpInvoker = new GridItemLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link net.evrem.service.service.GridItemLocalServiceUtil} to access the grid item local service.
     */
    ...
    @Override
    public GridItem addGridItem(GridItem gridItem) throws SystemException {
        gridItem.setNew(true);

        return gridItemPersistence.update(gridItem);
    }
     ...
     */
    @Override
    public GridItem createGridItem(long gridItemId) {
        return gridItemPersistence.create(gridItemId);
    }
    ...
    @Override
    public GridItem deleteGridItem(long gridItemId)
        throws PortalException, SystemException {
        return gridItemPersistence.remove(gridItemId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public GridItem deleteGridItem(GridItem gridItem) throws SystemException {
        return gridItemPersistence.remove(gridItem);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(GridItem.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return gridItemPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return gridItemPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return gridItemPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return gridItemPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public GridItem fetchGridItem(long gridItemId) throws SystemException {
        return gridItemPersistence.fetchByPrimaryKey(gridItemId);
    }
     ...
     */
    @Override
    public GridItem getGridItem(long gridItemId)
        throws PortalException, SystemException {
        return gridItemPersistence.findByPrimaryKey(gridItemId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return gridItemPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<GridItem> getGridItems(int start, int end)
        throws SystemException {
        return gridItemPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getGridItemsCount() throws SystemException {
        return gridItemPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public GridItem updateGridItem(GridItem gridItem) throws SystemException {
        return gridItemPersistence.update(gridItem);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("net.evrem.service.model.GridItem",
            gridItemLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = gridItemPersistence.getDataSource();
