...
/**
 * Provides the local service interface for RemindInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Zdenek Vecek
 * @see RemindInfoLocalServiceUtil
...
public interface RemindInfoLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link RemindInfoLocalServiceUtil} to access the remind info local service. Add custom service methods to {@link net.evrem.service.service.impl.RemindInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
