...
/**
 * Provides the local service interface for GridItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Zdenek Vecek
 * @see GridItemLocalServiceUtil
...
public interface GridItemLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link GridItemLocalServiceUtil} to access the grid item local service. Add custom service methods to {@link net.evrem.service.service.impl.GridItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
